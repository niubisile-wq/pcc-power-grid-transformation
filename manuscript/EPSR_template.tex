...
\begin{highlights}
\item Proof-carrying contracts bind model conversion evidence to the declared power-system task.
\item Full PCC rejected 1,320/1,320 harmful transformations and accepted 660/660 lawful controls.
...
\item Independent solver and CGMES controls confirmed portability across tools and data sources.
\end{highlights}
